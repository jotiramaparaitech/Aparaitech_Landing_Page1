      ...
      <div className="relative container mx-auto px-4 py-12 md:py-24 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            {/* Badge */}
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/30 backdrop-blur-sm">
              ...
              <span className="text-cyan-300 text-sm font-semibold tracking-wide">
                APARAITECH SOFTWARE • Live Enterprise Portfolio
              </span>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              ...
              <span className="bg-gradient-to-r from-blue-400 via-cyan-300 to-purple-400 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient">
            ...
            <p className="text-xl text-gray-300 max-w-2xl leading-relaxed">
              We architect, engineer, and deploy high-performance software systems and generative AI solutions. Explore our verified live production applications serving real-world businesses across multiple industries.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button
                onClick={() => navigate('/customers/portfolio')}
                className="group inline-flex items-center justify-center px-7 py-3.5 text-base sm:text-lg font-bold rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 transition-all duration-300 hover:scale-105 hover:shadow-2xl shadow-cyan-500/30 text-white"
              >
                <div className="mr-2.5 group-hover:rotate-12 transition-transform">
                  <Icons.Rocket />
                </div>
                Live Portfolio (7 Apps)
              </button>

              <button
                onClick={() => window.open('https://lms.aparaitech.org/', '_blank')}
                className="group inline-flex items-center justify-center px-6 py-3.5 text-base sm:text-lg font-semibold rounded-xl bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/20 transition-all duration-300 hover:scale-105"
              >
                Live Programs
              </button>
              ...
              <button
                ...
                className="group inline-flex items-center justify-center px-6 py-3.5 text-base sm:text-lg font-semibold rounded-xl bg-white/5 hover:bg-white/10 backdrop-blur-sm border border-white/10 transition-all duration-300 hover:scale-105"
              >
                Connect Us
              </button>
            </div>

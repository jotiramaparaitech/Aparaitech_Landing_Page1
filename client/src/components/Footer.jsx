...
const Footer = () => {
  ...
  const handleLinkClick = (link, e) => {
    ...
    // ✅ scroll sections (home page sections)
    if (link.id) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full flex flex-col md:flex-row justify-between gap-8 md:gap-4 px-0 py-1 mt-5">
        {/* Brand & Contact Section - Enhanced - Fixed responsive spacing - KEPT FROM 1ST COMPONENT */}
        <div className="flex flex-col items-center md:items-start w-full md:w-2/5 px-4 sm:px-6 md:px-8">
          {/* Premium Logo Container - Reduced bottom margin on mobile - KEPT FROM 1ST COMPONENT */}
          ...
          {/* Enhanced Company Description - Updated with contact info - Reduced spacing on mobile - KEPT FROM 1ST COMPONENT */}
        ...
        {/* Enhanced Company Links - Fixed hover area and layout stability - KEPT FROM 1ST COMPONENT */}
        <div className="flex flex-col items-center md:items-start w-full md:w-1/4 px-4 sm:px-6 md:px-8">
          ...
          {/* Navigation Links - USING 2ND COMPONENT'S LINKS */}
        ...
        {/* Enhanced Newsletter Section with Social Icons - KEPT FROM 1ST COMPONENT */}
        <div className="flex flex-col items-center md:items-start w-full md:w-1/3 px-4 sm:px-6 md:px-8">
          ...
          {/* USING 2ND COMPONENT'S SUBSCRIBE LOGIC */}
          <form onSubmit={handleSubscribe} className="w-full">
            <div className="space-y-4">
              ...
              {/* USING 2ND COMPONENT'S MESSAGE HANDLING */}
              {message && (
                <div
          ...
          {/* Social Icons - KEPT FROM 1ST COMPONENT */}
          <div className="mt-3">
      ...
      {/* Animation Keyframes - KEPT FROM 1ST COMPONENT */}
      <style>{`

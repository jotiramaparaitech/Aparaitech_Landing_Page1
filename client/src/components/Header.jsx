...
const Header = () => {
  ...
  const moreDropdownContent = {
    ...
    Customers: [
      { name: "Company Project Portfolio", link: "/customers/portfolio" },
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="flex flex-col space-y-4">
              ...
              >
                <span>Portfolio</span>
                <span className="px-2 py-0.5 text-xs bg-emerald-100 text-emerald-700 font-semibold rounded-full">
                  Live
                </span>
              </Link>
            </div>

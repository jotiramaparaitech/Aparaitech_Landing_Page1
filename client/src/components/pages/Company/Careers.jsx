...
const Careers = () => {
  ...
  return (
    <section className="bg-[#f9f9fb] pt-28 pb-20 min-h-screen">
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-1 text-sm text-gray-600">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-[#2d1b69]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
